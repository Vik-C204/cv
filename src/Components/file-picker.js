    ...
    constructor(props) {
        ...
        this.render = () => {
            ...
            return (react_2.default.createElement(input_1.InputGroup, Object.assign({}, inputGroupProps),
                ...
                !hideClearButton &&
                react_2.default.createElement(react_1.InputRightAddon, {style: {backgroundColor: "#333"}},
                    react_2.default.createElement(react_1.Button, { onClick: this.handleOnClearClick, colorScheme: "primary", height: "100%" }, clearButtonLabel !== null && clearButtonLabel !== void 0 ? clearButtonLabel : "Clear"))));
        };
        this.state = {
            files: null,
            fileName: ""
